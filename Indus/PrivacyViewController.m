...
@interface PrivacyViewController ()<ApiRequestdelegate,UIWebViewDelegate>
{
...
-(void)CustomView
{
   ...
   // NotificationButton.userInteractionEnabled=NO;
    ...
    NSString *html = [_arrChildCategory valueForKey:@"privacy_policy"];
