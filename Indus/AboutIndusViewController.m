...
@interface AboutIndusViewController ()<ApiRequestdelegate,UIWebViewDelegate>
{
...
@implementation AboutIndusViewController
...
-(void)CustomView
{
    ...
    titlelab.text=@"About Indus Healthcare";
  ...
  //  NotificationButton.userInteractionEnabled=NO;
    ...
    webview=[[UIWebView alloc]initWithFrame:CGRectMake(0, linelabel.frame.size.height+linelabel.frame.origin.y, self.view.frame.size.width, self.view.frame.size.height-117)];
    webview.backgroundColor=[UIColor clearColor];
    webview.delegate = self;
    NSString *html = [_arrChildCategory valueForKey:@"healthcare"];
