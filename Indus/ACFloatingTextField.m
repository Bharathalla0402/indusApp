...
-(void)initialization{
    ...
    if (_placeHolderTextColor == nil){
        _placeHolderTextColor = [UIColor colorWithRed:93.0/255.0f green:181.0/255.0f blue:80.0/255.0f alpha:1.0];
    }
    ...
    if (_btmLineColor==nil) {
        _btmLineColor = [UIColor colorWithRed:93.0/255.0f green:181.0/255.0f blue:80.0/255.0f alpha:1.0];
    }
    
    //4. Bottom line Color When Selected.
    if (_btmLineSelectionColor==nil) {
        _btmLineSelectionColor = [UIColor colorWithRed:49.0/255.0f green:89.0/255.0f blue:168.0/255.0f alpha:1.0];
    }
