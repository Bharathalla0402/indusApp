...
@interface CallenderView : UIView
...
- (BOOL)calendar:(CallenderView *)calendar willDeselectDate:(NSDate *)date;
- (void)calendar:(CallenderView *)calendar didDeselectDate:(NSDate *)date;

- (BOOL)calendar:(CallenderView *)calendar willChangeToMonth:(NSDate *)date;
- (void)calendar:(CallenderView *)calendar didChangeToMonth:(NSDate *)date;
