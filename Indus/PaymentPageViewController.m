...
@interface PaymentPageViewController () <UIWebViewDelegate, UIAlertViewDelegate, ApiRequestdelegate>
{
...
//#define Merchant_Key @"tB1xQBgt"
//#define Salt @"Wm4h07yAIr"
...
#define Success_URL @"https://www.payumoney.com/mobileapp/payumoney/success.php"
#define Failure_URL @"https://www.payumoney.com/mobileapp/payumoney/failure.php"
#define Product_Info @"Booking Appointment"
#define Paid_Amount @"200.00"
#define Payee_Name @"Indus"
...
- (void)viewDidLoad {
    ...
    _webviewPaymentPage.backgroundColor=[UIColor whiteColor];
...
-(void)initPayment {
    ...
    NSString *email = _strEmailId;
    NSString *phone = _strPhone;
...
- (void)navigateToPaymentStatusScreen: (NSMutableDictionary *)mutDictTransactionDetails {
    ...
    {
        NSString *strStatus=[mutDictTransactionDetails valueForKey:@"Transaction_Status"];
        ...
        if ([strStatus isEqualToString:@"Success"])
        {
            ...
            paymentStatusViewController.strId=_strId;
        ...
        else
        {
            ...
            [requested showMessage:@"Your Transaction has not been completed. Please try Again" withTitle:@"Payment Status"];
        }
    });
}
