...
- (void)_init:(CKCalendarStartDay)firstDay {
    ...
    [prevButton setImage:[UIImage imageNamed:@"la.png"] forState:UIControlStateNormal];
    ...
    [nextButton setImage:[UIImage imageNamed:@"ra.png"] forState:UIControlStateNormal];
    ...
    calendarContainer.backgroundColor=[UIColor colorWithRed:93.0/255.0f green:181.0/255.0f blue:80.0/255.0f alpha:1.0];
...
- (void)setMonthButtonColor:(UIColor *)color {
    [self.prevButton setImage:[CallenderView _imageNamed:@"la.png" withColor:color] forState:UIControlStateNormal];
    [self.nextButton setImage:[CallenderView _imageNamed:@"ra.png" withColor:color] forState:UIControlStateNormal];
}
